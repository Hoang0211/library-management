export const GET_ALL_BORROW_REQUEST = 'GET_ALL_BORROW_REQUEST';
export const GET_ALL_BORROW_SUCCESS = 'GET_ALL_BORROW_SUCCESS';
export const GET_ALL_BORROW_FAILURE = 'GET_ALL_BORROW_FAILURE';
export const CLEAR_GET_ALL_BORROW_ERROR = 'CLEAR_GET_ALL_BORROW_ERROR';
